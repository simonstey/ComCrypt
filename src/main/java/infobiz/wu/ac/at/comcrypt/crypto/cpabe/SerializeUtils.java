...
//		System.out.println("Size of offset: "+offset[0]);
//		System.out.println("Size of n/children: "+n);
		offset[0] += 4;
		if (n == 0) {
			p.children = null;
			...
			for (i = 0; i < n; i++){
//				System.out.println("\nbefore assignment offset is :"+offset[0]);
				p.children[i] = unserializePolicy(pub, arr, offset);
//			    System.out.println("\n now the offset is:"+offset[0]);
			}
		}
		return p;
	}
